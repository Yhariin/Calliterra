...
std::shared_ptr<VertexBuffer> Renderer::CreateVertexBuffer(float* vertices, size_t elementCount)
{
	switch(GetAPI())
	{
...
std::shared_ptr<VertexBuffer> Renderer::CreateVertexBuffer(float** listOfVertexArrays, size_t* listOfElementCounts, size_t bufferCount)
{
	switch(GetAPI())
	{
	case RendererAPI::None: 
